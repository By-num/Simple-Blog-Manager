...
function displayPosts() {
  fetch(API_URL)
    ...
    .then(posts => {
      ...
      // Advanced: Show first post details automatically
...
function handlePostClick(id) {
  fetch(`${API_URL}/${id}`)
    ...
    .then(post => {
      ...
      `;
      // Edit and Delete listeners for advanced deliverables
...
function addNewPostListener() {
  document.getElementById("new-post-form").addEventListener("submit", function(e) {
    ...
    // For advanced: persist with POST
    fetch(API_URL, {
      method: "POST",
